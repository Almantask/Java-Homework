...
public class Day3 {
    ...
    public static long solveDay3_1(List input) {
    ...
    public static ArrayList treesList(List input, int rightStep, int downStep) {
        ArrayList list = new ArrayList();
        int position = 0;
        for (int i = 0, inputSize = input.size(); i < inputSize; i = i + downStep) {
